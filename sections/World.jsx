...
const World = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| People on the Brazil" textStyles="text-center" />
      <TitleText
        textStyles="text-center"
        title={
          <>
            Our statistics are generated based on multiple bookmakers. Our unique database allows you to
            view the global iGamming scene in Brazil.
          </>
        }
      />
      <motion.div
